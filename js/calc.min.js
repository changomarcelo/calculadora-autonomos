...
function calcular_aut() {
	...
	*/
	...
	if ((resultado_neto - autonomos - seguroVida) * PORCENTAJE_DONACIONES/100 > donaciones)
		donaciones_deducibles = donaciones;
	else
		donaciones_deducibles = (resultado_neto - autonomos - seguroVida ) * PORCENTAJE_DONACIONES/100;
	...
	if ((resultado_neto - autonomos - seguroVida) * PORCENTAJE_CUOTAS_MEDICAS/100 > cuotas_medicas)
		cuotas_medicas_deducibles = cuotas_medicas;
	else
		cuotas_medicas_deducibles = (resultado_neto - autonomos - seguroVida ) * PORCENTAJE_CUOTAS_MEDICAS/100;
	...
	if ((resultado_neto - autonomos - seguroVida) * PORCENTAJE_HONORARIOS_MEDICOS/100 > honorarios_medicos)
		honorarios_medicos_deducibles = honorarios_medicos;
	else
		honorarios_medicos_deducibles = (resultado_neto - autonomos - seguroVida) * PORCENTAJE_HONORARIOS_MEDICOS/100;
	...
	if ((resultado_neto - autonomos - seguroVida - donaciones_deducibles - cuotas_medicas_deducibles - honorarios_medicos_deducibles) <=  int_men_max)
		intereses_deducibles = resultado_neto - autonomos - seguroVida - donaciones_deducibles - cuotas_medicas_deducibles - honorarios_medicos_deducibles;
	else
	...
	var alq_min_max = 0;
	if (alquileres * .4 <= ALQUILERES_MAX)
		alq_min_max = alquileres * .4;
	else
		alq_min_max = ALQUILERES_MAX;
	
	var alquiler_deducible = 0;
	if ((resultado_neto - autonomos - seguroVida - donaciones_deducibles - cuotas_medicas_deducibles - honorarios_medicos_deducibles - intereses_deducibles) <=  alq_min_max)
		alquiler_deducible = resultado_neto - autonomos - seguroVida - donaciones_deducibles - cuotas_medicas_deducibles - honorarios_medicos_deducibles - intereses_deducibles;
	else
